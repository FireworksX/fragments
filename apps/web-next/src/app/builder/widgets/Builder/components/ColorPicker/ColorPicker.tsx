      ...
      <div className={styles.controls}>
        <div className={styles.colorControls}>
          ...
          <div className={styles.hueWrapper}>
            {/*<Hue hsl={hsl} width='100%' height='8px' pointer={<div className={styles.pointer} />} onChange={onChange} />*/}
          </div>
        </div>
...
export default ColorPicker //CustomPicker(ColorPicker)
