...
export type ProjectDirectoryQuery = { __typename?: 'Query', directory: { __typename?: 'ProjectDirectoryGet', id: number, name: string, empty: boolean, parentId?: number | null, fragments: Array<{ __typename?: 'FragmentGet', id: number, name: string }> } };
