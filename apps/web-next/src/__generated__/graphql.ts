...
export type DirectoryFragment = { __typename?: 'ProjectDirectoryGet', id: number, parentId?: number | null, name: string, hasSubdirectories: boolean, directories: Array<{ __typename?: 'ProjectDirectoryGet', id: number, parentId?: number | null, name: string, hasSubdirectories: boolean }>, fragments: Array<{ __typename?: 'FragmentGet', id: number, name: string }> } & { ' $fragmentName'?: 'DirectoryFragment' };
...
export type ProjectDirectoryQuery = { __typename?: 'Query', directory: { __typename?: 'ProjectDirectoryGet', id: number, parentId?: number | null, name: string, hasSubdirectories: boolean, directories: Array<{ __typename?: 'ProjectDirectoryGet', id: number, parentId?: number | null, name: string, hasSubdirectories: boolean }>, fragments: Array<{ __typename?: 'FragmentGet', id: number, name: string }> } };
