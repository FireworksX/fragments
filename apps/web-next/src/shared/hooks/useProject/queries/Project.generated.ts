...
export type ProjectQuery = { __typename?: 'Query', project: Array<{ __typename?: 'ProjectGet', id: number, name: string, rootDirectoryId: number, logo: { __typename?: 'MediaGet', publicPath: string } }> };
