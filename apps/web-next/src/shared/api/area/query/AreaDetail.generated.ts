...
export type AreaDetailQuery = { __typename?: 'Query', area: Array<{ __typename?: 'AreaGet', id: number, description?: string | null, properties?: Array<any> | null, code: string, defaultCampaign: { __typename?: 'CampaignGet', id: number } }> };
