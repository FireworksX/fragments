...
import { useProjectsListQuery, useProjectsListSuspenseQuery } from '@/views/ProjectsList/queries/ProjectsList.generated'
...
export const useProjectsListView = () => {
  ...
  const { data } = useProjectsListSuspenseQuery()
