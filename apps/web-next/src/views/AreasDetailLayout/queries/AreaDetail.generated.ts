...
export type AreaDetailQuery = { __typename?: 'Query', area: { __typename?: 'AreaGet', id: number, name: string, description?: string | null, defaultCampaign: { __typename?: 'CampaignGet', id: number, active: boolean } } };
